...
est majoré par 2**N, mais dans la pratique je pense que cela sera beaucoup plus faible,
à taille humaine. D'autre part, je pense que la situation finale sera une
...
La valeur de a étant faible, on néglige son carré et on retombe sur l'équation de la rotation.
