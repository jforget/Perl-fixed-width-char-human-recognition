...
On remarquera que dans l'ancienne version, j'utilisais le bleu et le vert pour 
faire comme sur un damier, ne pas avoir deux cases adjacentes de la même couleur.
Avec la nouvelle version, je préfère utiliser le bleu pour mettre en évidence
les limites des Grilles.

On remarquera également qu'il reste des pixels rouges dans S<« gregorien »>. Ce n'est
...
les priorités après avoir trié les Grille en fonction de cette priorité,
...
Prendre en compte les annotations sur le listing the 19 janvier et corriger les éventuelles
...
Et finalement, j'ai complété ces mesures de sécurité par une mesure radicale,
...
dans le programme, mais le dépôt Git n'a pas été snchronisé avec Github.
...
raison que j'ignore, les fichiers ont été stockés en niveaux de gris. Certes, c'était
du I<1-bit grayscale>, mais c'était du gris très foncé avec du gris très clair et
