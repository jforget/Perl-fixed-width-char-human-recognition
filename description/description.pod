...
<p size='2'>Copie d'écran personnelle d'une page Wikipedia avec des modifications mineures. Comme indiqué dans la page Wikipedia,
<i lanfg='en'>Text is available under the Creative Commons Attribution-ShareAlike License; additional terms may apply.</i>
</p>
...
et celle d'un cisaillement vertical S<est :>
