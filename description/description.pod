...
puis par excès. Des deux coordonnées xg_c et xg_g, celle avec la partie fractionnaire
la plus petite est arrondie par défaut, tandis que l'autre est arrondie tantôt par
défaut, tantôt par excès. Idem pour les deux coordonnées yg_c et yg_g.
...
0,76 est inférieur à 0,82, donc l'abscisse xg_c est toujours arrondie par
défaut et c'est l'abscisse xg_g qui est arrondie par défaut dans la moitié des
essais et par excès dans l'autre moitié. En gardant le score le plus faible parmi
les quatre scores calculés, on réduit encore un peu plus le problème de la 
colonne bleue et de la colonne orange présenté ci-dessus.

Il est inutile de faire des essais en arrondissant les deux coordonnées xg_c et xg_g
par excès, il seront redondants avec les essais où les deux coordonnées sont
arrondies par défaut. Idem pour les ordonnées yg_c et yg_g.

Quant à arrondir xg_c par excès et xg_g par défaut, cela n'a pas de sens, 
cela contrevient à l'ordre dans lequel sont leurs parties fractionnaires.
...
Les quatre tentatives S<seront :>

  Centre de gravité Cellule    7  15     7  16    8  15    8  16
  Centre de gravité Glyphe     7  16     7  16    7  16    7  16

  Plage de valeurs X Cellule   0..16     0..16    0..16    0..16
  relative au CDG             -7.. 9    -7.. 9   -8.. 8   -8.. 8
  Plage de valeurs Y Cellule   0..29     0..29    0..29    0..29
  relative au CDG            -15..14   -16..13  -15..14  -16..13

  Plage de valeurs X Glyphe    0..15     0..15    0..15    0..15
  relative au CDG             -7.. 8    -7.. 8   -7.. 8   -7.. 8
  Plage de valeurs Y Glyphe    0..29     0..29    0..29    0..29
  relative au CDG            -16..13   -16..13  -16..13  -16..13

  Méthode 1
  Plage combinée X            -7.. 9    -7.. 9   -8.. 8   -8.. 8
  Plage combinée Y           -16..14   -16..13  -16..14  -16..13

  Plage X Cellule              0..16     0..16    0..16    0..16
  Plage Y Cellule             -1..29     0..29   -1..29    0..29
  Plage X Glyphe               0..16     0..16   -1..15   -1..15
  Plage Y Glyphe               0..30     0..29    0..30    0..29

  Méthode 2
  Plage combinée X            -7.. 8    -7.. 8   -7.. 8   -7.. 8
  Plage combinée Y           -15..13   -16..13  -15..13  -16..13

  Plage X Cellule              0..15     0..15    1..16    1..16
  Plage Y Cellule              0..28     0..29    0..28    0..29
  Plage X Glyphe               0..15     0..15    0..15    0..15
  Plage Y Glyphe               1..29     0..29    1..29    0..29
...
sélectionnés. Le champ C<cpt_car> contient l'histogramme par caractère
...
à deux Glyphes correspondant à deux Caractères différents,
