...
=for HTML
<img src="resultats-score.png" alt="Affichage d'un texte, les cellules étant coloriées selon leur score" />
...
Pour les coloriages permettant de 
...
parce que sinon, la largeur du champ aurait été très différente entre la première et dernière lignes,
...
Je lance Firefox à partir des menus déroulants de ma machine.  J'aurais pu le faire depuis
