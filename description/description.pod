...
<form action='/majgrille/ex1bis' method='post'>
...
<tr><td>0 <input name='l0' type='hidden' value='0' /></td>
<td>0 <input name='c0' type='hidden' value='0' /></td>
<td>0<input name='prio0' type='hidden' value='0'></td>
<td><select name='action0' size='1'><option>rien</option><option>saisie</option></select></td>
<td><input name='x00' value='42' size='6' /></td><td><input name='y00' value='27' size='6' /></td><td><input name='dx0' value='30.8' size='6' /></td><td><input name='dy0' value='49.5' size='6' /></td><td><select name='dirh0'><option selected='1'>gauche</option><option>droite</option></select></td><td><input name='cish0' value='3' size='6' /></td><td><select name='dirv0'><option>haut</option><option selected='1'>bas</option></select></td><td><input name='cisv0' value='3' size='6' /></td></tr>
<tr><td>3 <input name='l1' type='hidden' value='3' /></td>
<td>60 <input name='c1' type='hidden' value='60' /></td>
<td><input name='prio1' value='1' size='6'></td>
<td><select name='action1' size='1'><option>rien</option><option>saisie</option><option>calcul</option><option>suppression</option></select></td>
<td><input name='x01' value='1884' size='6' /></td><td><input name='y01' value='195' size='6' /></td><td><input name='dx1' value='28.5' size='6' /></td><td><input name='dy1' value='49.5' size='6' /></td><td><select name='dirh1'><option selected='1'>gauche</option><option>droite</option></select></td><td><input name='cish1' value='3' size='6' /></td><td><select name='dirv1'><option>haut</option><option selected='1'>bas</option></select></td><td><input name='cisv1' value='3' size='6' /></td></tr>
<tr><td>3 <input name='l2' type='hidden' value='3' /></td>
<td>67 <input name='c2' type='hidden' value='67' /></td>
<td><input name='prio2' value='2' size='6'></td>
<td><select name='action2' size='1'><option>rien</option><option>saisie</option><option>calcul</option><option>suppression</option></select></td>
<td><input name='x02' value='2086' size='6' /></td><td><input name='y02' value='197' size='6' /></td><td><input name='dx2' value='28.5' size='6' /></td><td><input name='dy2' value='49.5' size='6' /></td><td><select name='dirh2'><option selected='1'>gauche</option><option>droite</option></select></td><td><input name='cish2' value='3' size='6' /></td><td><select name='dirv2'><option>haut</option><option selected='1'>bas</option></select></td><td><input name='cisv2' value='3' size='6' /></td></tr>
<tr><td><input name='l3' size='3' /></td><td><input name='c3' size='3' /></td>
    <td><input name='prio3' size='3' /></td>
    <td><select name='action3' size='1'><option selected='1'>rien</option><option>saisie</option><option>calcul</option></select></td>
    <td><input name='x03' size='3' /></td>
    <td><input name='y03' size='3' /></td>
    <td><input name='dx3' size='3' /></td>
    <td><input name='dy3' size='3' /></td>
    <td><select name='dirh3' size='1'><option>gauche</option><option>droite</option></select></td>
    <td><input name='cish3' size='3' /></td>
    <td><select name='dirv3' size='1'><option>haut</option><option>bas</option></select></td>
    <td><input name='cisv3' size='3' /></td>
...
Exemple de S<Document :>
  ...
  {
        "_id" : ObjectId("592dc0087a7f462801253963"),
        "y0" : "298",
        "ind_noir" : 1,
        "cisv" : "0",
        "taille_x" : 2550,
        ...
        "doc" : "ex2",
        "dx" : "31",
        "dh_cre" : "2017-05-30 18:55:04",
        "grille" : "ex2-grille.png",
        "dh_grille" : "2017-06-06 19:50:34",
        "dirh" : "gauche",
        "dirv" : null,
        "dh_valid" : "2017-06-06 19:51:22"
  }

(avant mise en place de l'entité Grille).
...
À compléter lorsque l'entité Grille sera mise en place.
...
Clé alternative. Elle coïncide avec la clé C<car>, sauf pour les glyphes associés à l'espace.
Pour les espaces, on a la valeur C<"SP"> dans C<car1>, pour une meilleure lisibilité dans
les pages HTML. Évidemment, la clé (pour identifier le Glyphe) comporte aussi le champ C<num>,
