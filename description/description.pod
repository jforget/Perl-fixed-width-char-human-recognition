...
Ooops, c'est l'exposé de l'année précédente. Permettez-moi de faire quelques adaptations.
...
<p><font size='2'>Copie d'écran personnelle d'une page 
<a href='https://fr.wikipedia.org/wiki/Alphabet_ph%C3%A9nicien'>Wikipedia</a>
licence <a href='http://creativecommons.org/licenses/by-sa/3.0/deed.fr'>Creative Commons attribution, partage dans les mêmes conditions</a>
</font></p>

<img src="Liseuse.jpg" alt="La liseuse de Fragonard" />
<p><font size='2'>La Liseuse, par Fragonard (1732--1806), œuvre dans le domaine public.</font></p>
...
<p><font size='2'>En classe, le travail des petits, par Henri Jules Geoffroy (1853--1924), œuvre dans le domaine public. Avec un marquage par le site web où j'ai trouvé cette reproduction (pourquoi marquer une œuvre dans le domaine public&nbsp;?)</font></p>
...
<p size='1'> Source <a href='http://www.popscreen.com/p/MTU3MDkzMDU5/Soviet-CCCP-Astronaut-Space-Patch-Russian-Alexei-Leonov'>http://www.popscreen.com/p/MTU3MDkzMDU5/Soviet-CCCP-Astronaut-Space-Patch-Russian-Alexei-Leonov</a></p>

=end HTML

la plupart des systèmes donnent comme résultat S<« cécécépé »> (U+43 U+43 U+43 U+50),
alors qu'il faut lire en fait S<« èssèssèssère »> (U+0421 U+0421 U+0421 U+0420).
...
décalage d'un pixel vers le bas tous les trois caractères.
...
je l'ai mise en place sur ma base de données et dans mon applicatio et dans mon applicationn.
...
POD sur GitHub fait qu'il est automatiquement traduit en HTML.
