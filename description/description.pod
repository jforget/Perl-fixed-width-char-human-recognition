...
Pour les quatre fichiers source, passer la commande Emacs C<tabify>, pour remplacer les suites
...
Un premier C<commit> à la date du jour en 2017, pour ajouter des fichiers F<LICENSE>, F<README>
et F<LISEZMOI> et pour mettre dans le fichier source les commentaires requis par la GPL.

=item 6

Comme j'ai grandi et mûri depuis 1984, je n'utilise plus de tabulations en dehors des fichiers F<makefile>.
Donc, passer un C<untabify> sur le fichier source et commiter.
...
Si j'ai du temps disponible, j'essaierai de voir où la configuration cloche et
je la réactiverai.
