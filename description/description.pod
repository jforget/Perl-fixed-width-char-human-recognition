...
module GD et un module MongoDB. Si j'arrive à faire fonctionner tout cela,
je développerai mes programmes en Perl 6. Sinon, j'utiliserai au moins en partie
Perl 5. 
...
Un premier programme construit un histogramme
des données H et V (je ne saisis pas très
bien ce que représente la saturation,
donc j'ai fait l'impasse).

Un second programme passe en revue
...
fait du 400~DPI. Cela veut dire que chaque glyphe
correspond à un rectangle de 40x66~pixels.
...
Le programme de nettoyage permet de faire au choix une seule
...
le fonctionnement de l'algorihme de lissage et
de nettoyage.
...
Je n'ai pas prêté attention aux problèmes de mise à jour concurrente.
...
et utilise le résultat. En d'autres termes, le malfaiteur potentiel
