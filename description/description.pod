...
Un critère est une entité logique distincte de la Requête, mais dans le schéma
physique, tous les critères dépendant d'une Requête seront stockés dans un 
tableau de l'enregistrement Requête.
...
Peut-être vaudrait-il mieux nommer cette table S<« Coloriage »>...
