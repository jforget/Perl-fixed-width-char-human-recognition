...
Mais comme la notion de requête est plus associée à la notion de processus
...
La seconde méthode permet donc un calcul plus rapide. En revanche, s'il faut dessiner
...
Par exemple, un document Coloriage est identifié par le code du Document associé,
plus un numéro séquentiel et ce document Coloriage contient la liste des
Critères définis pour ce Coloriage.

La relation Critère-Cellule est implémentée en incluant la liste des couples
Cellule-Critère (uniquement les clés) dans le document Coloriage.
De même, la relation Cellule-Glyphe est implémentée en incluant la liste des
clés de Glyphe, plus quelques autres informations, dans le document de la Cellule.
...
=head3 Cellule
  ...
  {
	"_id" : ObjectId("5978f3167a7f460b407e1f13"),
	"yg" : 18.793478260869566,
	"hte" : 22,
	"ye" : 10,
	"xe" : 5,
	"doc" : "ex1",
	"xg" : 13.201086956521738,
	"glyphes" : [
		{
			"car" : "p",
			"num" : 1
...
Liste des Critères du Coloriage, liste incluse dans le document
