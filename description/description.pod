...
<p><font size='2'>Copie d'ecran personnelle d'une page 
<a href='https://fr.wikipedia.org/wiki/Alphabet_ph%C3%A9nicien'>Wikipedia</a>
licence <a href='http://creativecommons.org/licenses/by-sa/3.0/deed.fr'>Creative Commons attribution, partage dans les memes conditions</a>
</font></p>

<img src="Liseuse.jpg" alt="La liseuse de Fragonard" />
<p><font size='2'>La Liseuse, par Fragonard (1732--1806), oeuvre dans le domaine public.</font></p>
...
<p><font size='2'>En classe, le travail des petits, par Henri Jules Geoffroy (1853--1924), oeuvre dans le domaine public. Avec un marquage par le site web où j'ai trouvé cette reproduction (pourquoi marquer une oeuvre dans le domaine public&nbsp;?)</font></p>
