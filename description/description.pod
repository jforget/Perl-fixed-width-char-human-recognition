...
prenne pour exemple une calculatrice à quatre opération, que tout programme de modélisation 3D affiche une
...
=item 1 Le Document est créé.

=item 2 Les informations de grille sont saisies et le fichier généré.

=item 3 La grille est validée, c'est-à-dire que les Cellules ont été
générées en fonction de cette grille.

=item 4 La procédure d'association a été lancée pour toutes les Cellules
du Document

=item 5 Le fichier texte final a été généré.

=back

À suivre lorsque l'entité Grille sera mise en place.
...
Date-heure de création, pour d'éventuels besoins techniques, on ne sait jamais. Fuseau UTC
pour éviter les problèmes avec l'heure d'été.
...
les pixels se font de 0 à C<lge - 1> et de 0 à C<hte - 1>.
